### OCR + Vector Search + LLM Pipeline

## This project demonstrates an end-to-end pipeline for extracting text from PDFs using PaddleOCR, storing embeddings in Qdrant (a local vector database), performing hybrid search, and leveraging Qwen2.5-0.5B-Instruct with vLLM for response generation.
